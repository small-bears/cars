...
public class ZulindingdanController {
    ...
    public R page(@RequestParam Map<String, Object> params,ZulindingdanEntity zulindingdan,
		...
		if(tableName.equals("yewuyuan")) {
			zulindingdan.setYewuyuanzhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		if(tableName.equals("yewuyuan")) {
			wrapper.eq("yewuyuanzhanghao", (String)request.getSession().getAttribute("username"));
		}
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
		...
		if(tableName.equals("yewuyuan")) {
            ew.eq("yewuyuanzhanghao", (String)request.getSession().getAttribute("username"));
		}
